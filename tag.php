    ...
    <div class="container">
      <div id="contentInner" class="container px-0">
        <div class="st-main px-0">
          ...
          <section id="breadcrumb" class="bc-top-tag">
            <ol itemscope itemtype="http://schema.org/BreadcrumbList">
              <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a href="/howto-training" itemprop="item">
                  <span itemprop="name">How To Training</span>
                </a> &gt;
                <meta itemprop="position" content="1" />
              </li>
              <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a href="<?php echo esc_attr($base_url); ?>" itemprop="item">
                  <span itemprop="name"><?php echo esc_html($tag_name); ?></span>
                </a>
          ...
          <article>
            <h1 class="entry-title">「 <?php echo esc_html($tag_name); ?> 」 一覧 </h1>
